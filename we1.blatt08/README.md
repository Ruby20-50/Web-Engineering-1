...
4. Führen Sie `npm install` im Projektverzeichnis aus.
   Dies ist nur notwendig, um die Abgabe erzeugen zu können. Sie werden in diesem Aufgabenblatt keinen JavaScript/TypeScript-Code schreiben.
...
**In diesem Aufgabenblatt schreiben Sie keine Tests.**

Für die Abgabe erstellen Sie eine Zip-Datei `abgabe-Blatt_08.zip` mittels
```
npm run abgabe
```
